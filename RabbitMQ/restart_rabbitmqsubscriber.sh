...
kubectl apply -f appsettings.Production.yml,rabbitmq_secret.yml,svc-rabbitmqsubscriber.yml,rabbitmq-kern-subscriber.yml,rabbitmq-critical-subscriber.yml
